...
class TestOverlayManagement:
    ...
    def test_show_url_input_when_hidden(self):
        ...
        assert self.app.url_input_visible is True
    ...
    def test_show_url_input_when_prompt_editor_visible(self):
        ...
        assert self.app.url_input_visible is False
    ...
    def test_hide_overlays_when_both_visible(self):
        ...
        assert self.app.url_input_visible is False
        assert self.app.prompt_editor_visible is False
    ...
    def test_show_prompt_editor_for_llm_view(self):
        ...
        assert self.app.prompt_editor_visible is True
    ...
    def test_show_prompt_editor_for_raw_view(self):
        ...
        # Should show warning
        self.app.notify.assert_called_once_with(message="Raw view doesn't use prompts", severity="warning")
    ...
    def test_show_prompt_editor_invalid_view(self):
        ...
        # Should show error
        self.app.notify.assert_called_once_with(message="Invalid view: nonexistent", severity="error")
