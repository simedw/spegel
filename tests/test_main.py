...
class TestAppConfiguration:
    ...
    def test_app_uses_config_title(self):
        ...
        with patch("spegel.main.load_config") as mock_load_config:
            mock_config = create_mock_config(app_title="Custom Title")
            mock_load_config.return_value = mock_config
    ...
    def test_app_uses_config_default_view(self):
        ...
        with patch("spegel.main.load_config") as mock_load_config:
            custom_views = [Mock(id="custom", enabled=True), Mock(id="raw", enabled=True)]
            mock_config = create_mock_config(views=custom_views, default_view="custom")
            mock_load_config.return_value = mock_config
